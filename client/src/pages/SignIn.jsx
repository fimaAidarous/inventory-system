...
const SignIn = () => {
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: 'white', padding: 2, borderRadius: 4, boxShadow: 3, border: '1px solid green', width: '80%', maxWidth: 400 }}>
        ...
        <form onSubmit={handleSubmit} style={{ width: '90%' }}>
          ...
          <Button
            ...
            type="submit"
            variant="contained"
            sx={{ mt: 2, mb: 1, backgroundColor: '#00796b', color: '#ffffff' }}
            size="small"
          >
            Sign In
          </Button>
